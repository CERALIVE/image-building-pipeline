...
#       - the sysext refresh protocol (docs/addon-sysext-refresh.md): a
...
#         purely the sysext artifact (manifests/addons/debug-toolset.json).
...
ADDON_DESCRIPTOR="${PIPELINE_DIR}/manifests/addons/${ADDON_ID}.json"
