...
#
#   3. DEV-LOOP SANITY     → dev-push (REQUIRED in the release gate)
...
DEV_PUSH="${DEV_PUSH:-${PIPELINE_DIR}/dev-push}"
...
SHARED_LIST="${SHARED_LIST:-${PIPELINE_DIR}/manifests/packages/shared.list}"
PKG_MANIFEST_DIR="${PKG_MANIFEST_DIR:-${PIPELINE_DIR}/manifests/packages}"
