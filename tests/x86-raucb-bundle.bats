...
#
# This is the END-TO-END twin of mkosi-image-contract.bats §11 (reproducibility): there the
...
#
# PKI: the THROWAWAY dev keypair generated under .dev-keys (root-ca.pem, chain.pem,
...
setup() {
  ...
  DEV_KEYS="$PIPELINE_DIR/.dev-keys"
