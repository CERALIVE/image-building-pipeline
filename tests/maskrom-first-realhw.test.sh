...
UART="${PIPELINE_DIR}/ci/uart-provision-ssh.sh"
BOOT_SCRIPT="${PIPELINE_DIR}/mkosi/platform/boot/boot.scr.cmd"
SSH_FIRSTBOOT="${PIPELINE_DIR}/mkosi/runtime/ceralive-ssh-firstboot.sh"
SSH_FIRSTBOOT_UNIT="${PIPELINE_DIR}/mkosi/runtime/ceralive-ssh-firstboot.service"
UART_BOOTSTRAP="${PIPELINE_DIR}/mkosi/runtime/ceralive-ci-uart-bootstrap.sh"
UART_BOOTSTRAP_UNIT="${PIPELINE_DIR}/mkosi/runtime/ceralive-ci-uart-bootstrap.service"
UART_BOOTSTRAP_PUBLIC="${PIPELINE_DIR}/mkosi/runtime/ceralive-ci-uart-bootstrap-public.pem"
POSTINST_LIB="${PIPELINE_DIR}/mkosi/customize/postinst-lib.sh"
POSTINST_D="${PIPELINE_DIR}/mkosi/customize/postinst.d"
RELEASE_WORKFLOW="${REPO}/.github/workflows/release.yml"
REVOKE="${PIPELINE_DIR}/ci/revoke-ephemeral-ssh.sh"
LOADER_FETCH="${PIPELINE_DIR}/ci/fetch-rk3588-loader.sh"
DEV_PUSH="${PIPELINE_DIR}/dev-push"
TMP="$(mktemp -d)"
...
grep -Fq '.retain-once' "${PIPELINE_DIR}/tests/rauc-rollback.sh" || {
