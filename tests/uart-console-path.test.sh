...
UNIT="${PIPELINE_DIR}/mkosi/runtime/ceralive-ci-uart-bootstrap.service"
UART_PROVISION="${PIPELINE_DIR}/ci/uart-provision-ssh.sh"
BOOTSTRAP="${PIPELINE_DIR}/mkosi/runtime/ceralive-ci-uart-bootstrap.sh"
