...
selector (`mkosi/platform/boot/boot.scr.cmd`) loads `/boot/Image`,
...
Baked by `mkosi/customize/postinst-lib.sh::freeze_boot_packages`, called last
...
| Piece | Path |
|---|---|
| The freeze function | `mkosi/customize/postinst-lib.sh::freeze_boot_packages` |
