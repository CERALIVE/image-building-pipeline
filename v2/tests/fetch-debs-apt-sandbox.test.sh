...
# documented `TMPDIR=/tmp ./v2/run-tests` invocation moves around.
CTX="${RUN_DIR}/ctx"
mkdir -p "${CTX}/repo/v2/tests/fixtures"
cp -a "${V2}/lib" "${V2}/manifests" "${CTX}/repo/v2/"
cp -a "${TESTS_DIR}/fixtures/apt-sandbox" "${CTX}/repo/v2/tests/fixtures/"
