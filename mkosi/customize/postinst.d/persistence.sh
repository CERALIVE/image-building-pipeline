...
CERALIVE_NEVER_FREEZE_PKGS="${CERALIVE_NEVER_FREEZE_PKGS:-cerastream ceralive-device srtla-send-rs srtla gstreamer1.0-libuvcsrc gstreamer1.0-libuvch264src libsrt1.5-ceralive rauc-hawkbit-updater modemmanager libmm-glib0 libmbim-glib4 libmbim-proxy libmbim-utils libqmi-glib5 libqmi-proxy libqmi-utils libqrtr-glib0}"
...
freeze_boot_packages() {
  ...
  mkdir -p "${pref_dir}"
  {
    ...
    printf '# docs/partition-contract.md rule 3 and docs/kernel-freeze-contract.md).\n'
