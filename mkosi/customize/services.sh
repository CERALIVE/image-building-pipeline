...
# tracks now share postinst-lib.sh, and ci/postinst-drift-check.sh fails CI if
...
# mkosi/runtime/; postinst-lib.sh installs them from CERALIVE_RUNTIME_SRC.
